...
import http.client
import urllib.parse
from test_framework.digicoinconfig import COINBASE_MATURITY, INITIAL_BLOCK_REWARD
...
class RESTTest (BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        not_related_address = convert_btc_address_to_digicoin("2MxqoHEdNQTyYeX1mHcbrrpzgojbosTpCvJ")
