...
private:
    ...
    void StakeDigiCoins(bool fStake, CConnman* connman);
...
public:
    ...
    /* Start staking digicoins */
    void StartStake(CConnman* connman) { StakeDigiCoins(true, connman); }

    /* Stop staking digicoins */
    void StopStake() { StakeDigiCoins(false, 0); }
