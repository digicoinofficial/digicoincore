...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // digicoin
        hashUTXORoot.SetNull(); // digicoin
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //digicoin
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //digicoin
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //digicoin
    {
