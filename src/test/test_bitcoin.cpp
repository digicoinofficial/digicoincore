...
////////////////////////////////////////////////////////////// digicoin
        ...
        globalState = std::unique_ptr<DigiCoinState>(new DigiCoinState(dev::u256(0), DigiCoinState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::digicoinTestNetwork)));
