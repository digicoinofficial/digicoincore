...
static UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturn information about the given digicoin address.\n"
            "DEPRECATION WARNING: Parts of this command have been deprecated and moved to getaddressinfo. Clients must\n"
            "transition to using getaddressinfo to access this information before upgrading to v0.18. The following deprecated\n"
            "fields have moved to getaddressinfo and will only be shown here with -deprecatedrpc=validateaddress: ismine, iswatchonly,\n"
            "script, hex, pubkeys, sigsrequired, pubkey, addresses, embedded, iscompressed, account, timestamp, hdkeypath, kdmasterkeyid.\n"
            "\nArguments:\n"
            "1. \"address\"     (string, required) The digicoin address to validate\n"
            "\nResult:\n"
            "{\n"
...
UniValue getdgpinfo(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("maxblocksize", (uint64_t)digicoinDGP.getBlockSize(chainActive.Height()));
    obj.pushKV("mingasprice", (uint64_t)digicoinDGP.getMinGasPrice(chainActive.Height()));
    obj.pushKV("blockgaslimit", (uint64_t)digicoinDGP.getBlockGasLimit(chainActive.Height()));
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}")
        );
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}")
        );
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}")
            );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}")
        );
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\"]}")
        );
...
static UniValue createmultisig(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        std::string msg = "createmultisig nrequired [\"key\",...] ( \"address_type\" )\n"
            ...
            "2. \"keys\"                       (string, required) A json array of keys which are digicoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"                    (string) digicoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The digicoin address to use for the signature.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"DUi6wLm2d1zdbFxtgztpW9Yh8fTWY6ZXtr\", \"signature\", \"my message\"")
        );
...
static UniValue echo(const JSONRPCRequest& request)
{
    if (request.fHelp)
        throw std::runtime_error(
            ...
            "digicoin-cli and the GUI. There is no server-side difference."
        );
