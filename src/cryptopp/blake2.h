...
struct BLAKE2_Info : public VariableKeyLength<(T_64bit ? 64 : 32),0,(T_64bit ? 64 : 32),1,SimpleKeyingInterface::NOT_RESYNCHRONIZABLE>
{
	...
	CRYPTOPP_CONSTANT(SIZE = (T_64bit ? 16 : 8))
...
{
	CRYPTOPP_CONSTANT(SIZE = BLAKE2_Info<true>::SIZE)
...
{
	CRYPTOPP_CONSTANT(SIZE = BLAKE2_Info<false>::SIZE)
...
public:
	...
	CRYPTOPP_CONSTANT(BLOCKSIZE = BLAKE2_Info<T_64bit>::BLOCKSIZE)
	CRYPTOPP_CONSTANT(SIZE = BLAKE2_Info<T_64bit>::SIZE)
