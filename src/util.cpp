...
const char * const BITCOIN_CONF_FILENAME = "digicoin.conf";
const char * const BITCOIN_PID_FILENAME = "digicoind.pid";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\DigiCoin
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\DigiCoin
    // Mac: ~/Library/Application Support/DigiCoin
    // Unix: ~/.digicoin
#ifdef WIN32
    // Windows
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/DigiCoin";
#else
    // Unix
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("DigiCoin Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The DigiCoin Core developers";
    }
