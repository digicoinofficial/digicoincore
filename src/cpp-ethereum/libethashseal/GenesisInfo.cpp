...
#include "genesis/digicoinMainNetwork.cpp"
#include "genesis/digicoinTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::digicoinMainNetwork: return c_genesisInfoDigiCoinMainNetwork;
	case Network::digicoinTestNetwork: return c_genesisInfoDigiCoinTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::digicoinMainNetwork: return c_genesisStateRootDigiCoinMainNetwork;
	case Network::digicoinTestNetwork: return c_genesisStateRootDigiCoinTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
