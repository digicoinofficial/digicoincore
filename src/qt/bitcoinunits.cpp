...
QString BitcoinUnits::longName(int unit)
{
    ...
    case uBTC: return QString::fromUtf8("μ (bits)");
...
QString BitcoinUnits::description(int unit)
{
    ...
    case mBTC: return QString("Milli-DigiCoins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-DigiCoins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
