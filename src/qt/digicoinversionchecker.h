...
#define _RELEASES "https://github.com/digicoinofficial/DigiCoin-Core/releases"
...
class DigiCoinVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit DigiCoinVersionChecker(QObject *parent = 0);
    ~DigiCoinVersionChecker();
