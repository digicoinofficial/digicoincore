    ...
    platformStyle(_platformStyle)
{
    ...
    TokenPage = new Token(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    TokenPage->setClientModel(_clientModel);
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    TokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(TokenPage);
    TokenPage->on_goToSendTokenPage();
}

void WalletView::gotoReceiveTokenPage()
{
    setCurrentWidget(TokenPage);
    TokenPage->on_goToReceiveTokenPage();
}

void WalletView::gotoAddTokenPage()
{
    setCurrentWidget(TokenPage);
    TokenPage->on_goToAddTokenPage();
}
