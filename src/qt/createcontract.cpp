    ...
    m_results(1)
{
    ...
    ui->labelSenderAddress->setToolTip(tr("The digicoin address that will be used to create the contract."));
...
void CreateContract::setLinkLabels()
{
    ...
    ui->labelToken->setText("<a href=\"https://github.com/digicoinofficial/20Token\">Token template</a>");
}
...
void CreateContract::on_gasInfoChanged(quint64 blockGasLimit, quint64 minGasPrice, quint64 nGasPrice)
{
    ...
    ui->labelGasPrice->setToolTip(tr("Gas price:  price per gas unit. Default = %1, Min = %2").arg(QString::fromStdString(FormatMoney(DEFAULT_GAS_PRICE))).arg(QString::fromStdString(FormatMoney(minGasPrice))));
