...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " digicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  digicoin-tx [options] <hex-tx> [commands]  Update hex-encoded digicoin transaction\n" +
            "or:     digicoin-tx [options] -create [commands]   Create hex-encoded digicoin transaction\n" +
            "\n";
